...
dict(
  id='case-07', cat='体験 ／ 展示企画', title='GREEN×EXPO 2027 展示企画 実績資料',
  lead='2027年国際園芸博覧会へ向けた体験型展示の企画資料。横浜市の3つの行政区・部局の脱炭素・資源循環施策を、「ハンドルを回す」「クイズに答える」「蛇口をひねる」という身体操作の展示に翻訳し、資料の中でプロトタイプがそのまま動きます。',
  main=S('w07','case1-demo','GREEN×EXPO｜Case01 カーボンリサイクル体験ゾーン — ハンドルを回すとCO₂循環が動く'),
  mids=[S('w07','hero','GREEN×EXPO｜表紙 —「知られていない」を、触って驚く展示に変える'),
        S('w07','case2-answer','GREEN×EXPO｜Case02 ◯×クイズ — みなとみらいのリサイクル'),
        S('w07','case3-water','GREEN×EXPO｜Case03 蛇口をひねる — 水源林と省エネ水道')],
  smalls=[S('w07','case1-plan','GREEN×EXPO｜Case01 企画コンセプトと素材・仕様'),
          S('w07','case2-quiz','GREEN×EXPO｜Case02 クイズ筐体のデモ'),
          S('w07','mid1','GREEN×EXPO｜展示什器の構成資料（1）'),
          S('w07','mid2','GREEN×EXPO｜展示什器の構成資料（2）')],
  bg='代理店側の企画立案として、体験型展示什器を3案件にわたり設計。企画書そのものをインタラクティブにすることで、決裁者が「読む」のではなく「体験して」判断できる提案形式を発明しました。',
  can=['Case01 鶴見区｜ハンドルを長押しで回すとCO₂が資源に変わる循環が動き出す',
       'Case02 みなとみらい21区｜◯×クイズで脱炭素の取り組みを学ぶ（採点付き）',
       'Case03 横浜市水道局｜蛇口をひねると水源林から家庭まで水が流れる',
       '各ケースに企画コンセプト・素材・仕様・模型写真を併記した提案書構成'],
  use='行政・自治体の広報展示、博覧会、企業パビリオン。エンターテイメントとして成立させながら、政策メッセージを確実に届ける形です。',
  spec=[('分類','体験型展示の企画・プロトタイプ'),
        ('対象','GREEN×EXPO 2027（2027年国際園芸博覧会・横浜）'),
        ('案件','鶴見区 ／ みなとみらい21区 ／ 横浜市水道局（3案件）'),
        ('形式','インタラクティブ企画書（実働デモ同梱）'),
        ('デモ','ハンドル操作・◯×クイズ・蛇口操作'),
        ('提供形態','単一HTML（11.4MB）')],
),
dict(
