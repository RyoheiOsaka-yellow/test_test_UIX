...
const LOCATION_PRESETS = [
  ...
  { id: "asia-india", region: "asia", label: "インドの旧市街 (バラナシ/ジャイプル風)",
    en: "an old Indian city quarter", tags: ["色彩", "雑踏", "朝霧"],
    arch: "dense sandstone and painted facades, carved balconies, temple spires between houses",
    material: "pink and ochre painted plaster, carved stone, marigold garlands",
    signage: "hand-painted Hindi and English shop boards stacked over doorways",
    vegetation: "sacred fig trees at corners, marigolds and vines on shrines",
    ground: "worn stone steps and lanes shared by people, carts and cattle",
    life: "rickshaws, spice sacks, saris drying, temple bells and smoke",
    sky: "hazy warm sky, dust and incense softening the light",
    lightNote: "朝は霧とほこりで光が拡散し逆光が神々しく出る。日中は硬い直射",
    permit: "州ごとの撮影許可と現地フィクサーが実質必須。宗教施設は別許可" },
  { id: "asia-shanghai", region: "asia", label: "上海の摩天楼と外灘 (夜景)",
    en: "the Shanghai skyline and Bund waterfront", tags: ["夜", "超高層", "ネオン"],
    arch: "futuristic supertall towers across the river from colonial stone banks",
    material: "glass curtain walls, LED media facades, polished granite promenade",
    signage: "huge animated LED signage in Chinese characters on tower crowns",
    vegetation: "clipped street trees along the promenade, planters",
    ground: "wide polished stone riverside walkway, metal railings",
    life: "dense crowds taking photos, river barges and lit ferries passing",
    sky: "night sky washed out by city glow, haze catching the neon",
    lightNote: "夜はビル群のLEDが面光源になる。日没直後が空とネオンの両立点",
    permit: "外灘は人流規制が厳しい。三脚は時間帯規制あり。ドローンほぼ不可" },
  /* ---------- ヨーロッパ ---------- */
  ...
  { id: "eu-aegean", region: "eu", label: "エーゲ海の白い島 (サントリーニ風)",
    en: "a whitewashed Aegean island village", tags: ["白壁", "海", "強光"],
    arch: "cubic whitewashed houses with blue domes stacked on a cliff",
    material: "thick lime-washed plaster, blue painted wood, rounded steps",
    signage: "tiny hand-painted Greek signs, almost none",
    vegetation: "bougainvillea spilling over white walls, potted geraniums",
    ground: "painted stone paths outlined in white, steep stairs",
    life: "donkeys on steps, cafe tables, church bells, ferries below",
    sky: "deep saturated blue sky over a bright sea horizon",
    lightNote: "白壁が巨大なレフになり影が浮く。真昼は飛びやすく朝夕が別世界",
    permit: "観光地の混雑回避で早朝撮影が基本。教会・私有テラスは個別許可" },
  { id: "eu-alps", region: "eu", label: "アルプスの高原と山小屋",
    en: "an Alpine meadow with wooden chalets", tags: ["山岳", "草原", "清澄"],
    arch: "dark timber chalets with stone bases and deep eaves, church steeple in the valley",
    material: "weathered larch wood, granite, cowbells and split firewood",
    signage: "carved wooden trail signs, yellow hiking route markers",
    vegetation: "wildflower meadows, dark spruce forest edges, snow patches above",
    ground: "grassy slopes with dirt trails, streams with pale stones",
    life: "grazing cows with bells, hikers, cable car lines in the distance",
    sky: "crisp clear high-altitude sky, fast afternoon clouds on peaks",
    lightNote: "空気が澄み遠景までコントラストが残る。午後は山影が急に落ちる",
    permit: "牧草地は牧畜家の許可。ドローンは自然保護区とリフト周辺が不可" },
  /* ---------- 北米 ---------- */
  ...
  { id: "na-forest", region: "na", label: "北米の針葉樹林と湖 (パシフィック・ノースウェスト風)",
    en: "a Pacific Northwest conifer forest and lake", tags: ["霧", "湖面", "苔"],
    arch: "a lone wooden dock and distant cabins, no urban structures",
    material: "wet dark bark, moss, driftwood, still water",
    signage: "small trailhead boards, bear warning signs",
    vegetation: "towering firs and cedars, ferns, moss on every surface",
    ground: "soft needle-covered soil, rocky shoreline, mirror-like lake",
    life: "loons calling, a canoe, campfire smoke far away",
    sky: "low clouds and fog threading through the treetops",
    lightNote: "霧の日は完璧な巨大ディフューザー。晴天は林内が3〜4段暗く落ちる",
    permit: "国立・州立公園の商用撮影許可。焚き火・ドローンは規制が厳しい" },
  /* ---------- 中南米 ---------- */
  ...
  { id: "latam-rio", region: "latam", label: "リオのビーチ (コパカバーナ風)",
    en: "a Rio de Janeiro beachfront", tags: ["海岸", "活気", "夕景"],
    arch: "curved white apartment blocks along the bay, granite peaks behind",
    material: "the black-and-white wave mosaic promenade, sand, beach kiosks",
    signage: "kiosk menus in Portuguese, football flags",
    vegetation: "palms along the promenade, forested mountains behind the city",
    ground: "wide golden sand, mosaic sidewalk, bike lane",
    life: "beach volleyball and futevôlei, vendors calling, joggers at dawn",
    sky: "humid bright sky, dramatic clouds catching sunset behind the peaks",
    lightNote: "午後は海からの照り返しが強い。夕方は山のシルエットと残照が主役",
    permit: "市のビーチ撮影許可。機材の盗難対策と現地スタッフが現実的" },
  { id: "latam-mexico", region: "latam", label: "メキシコのカラフルな街区 (オアハカ風)",
    en: "a colorful Mexican colonial town", tags: ["原色", "祭", "石畳"],
    arch: "single-storey colonial houses painted in saturated pink, blue and ochre",
    material: "rough painted stucco, carved wooden doors, papel picado bunting",
    signage: "hand-painted Spanish shop lettering, mural walls",
    vegetation: "cacti in pots, jacaranda and bougainvillea over walls",
    ground: "green stone cobbles, high sidewalks",
    life: "street food smoke, marimba, markets spilling onto the street",
    sky: "clear high-plateau sky, sharp shadows",
    lightNote: "原色の壁同士が色を照り返し合う。白壁の街より1段彩度が乗る",
    permit: "自治体の許可。祭事期間は交渉が必要だが画は最高になる" },
  /* ---------- 中東・アフリカ ---------- */
  ...
  { id: "mena-istanbul", region: "mena", label: "イスタンブールの旧市街",
    en: "the old city of Istanbul", tags: ["モスク", "海峡", "夕光"],
    arch: "domes and minarets on the skyline, Ottoman timber houses on steep lanes",
    material: "worn stone, painted timber, brass shopfronts, carpets hung out",
    signage: "Turkish shop signs, hand-lettered tea house boards",
    vegetation: "fig trees in courtyards, vines over narrow lanes",
    ground: "steep cobbled lanes, tram rails on the main street",
    life: "call to prayer overlapping from minarets, ferries, tea sellers, cats",
    sky: "soft marine haze over the Bosphorus, gulls circling",
    lightNote: "海峡の湿気で夕光が滲む。モスクのシルエットは日没後20分が勝負",
    permit: "モスク内は宗教上の配慮と許可。観光地区の三脚は規制あり" },
  { id: "mena-dubai", region: "mena", label: "ドバイの超高層とハイウェイ",
    en: "the Dubai skyline and highway", tags: ["未来", "砂漠", "夜"],
    arch: "a wall of supertall glass towers rising straight from the desert",
    material: "mirrored glass, white concrete, 12-lane asphalt",
    signage: "monumental English and Arabic corporate logos on tower crowns",
    vegetation: "irrigated palms in medians, none beyond the city edge",
    ground: "immaculate highway, sand drifting at the fringes",
    life: "streams of headlights, metro trains on elevated tracks",
    sky: "dusty haze that turns gold at dusk, towers vanishing into it",
    lightNote: "砂塵の霞で高層の上部が消える。ブルーアワーの街灯りが最も密度が出る",
    permit: "公共空間の商用撮影は事前許可制。ドローンは免許と申請が必須" },
  { id: "mena-sahara", region: "mena", label: "サハラの大砂丘",
    en: "Saharan sand dunes", tags: ["砂丘", "無音", "斜光"],
    arch: "no structures, a berber tent camp at most",
    material: "fine ripple-textured orange sand, nothing else",
    signage: "none",
    vegetation: "a rare tamarisk bush between dunes",
    ground: "knife-edged dune crests, untouched slip faces",
    life: "camel caravan silhouettes, absolute silence, stars at night",
    sky: "cloudless gradient sky, heat shimmer at noon",
    lightNote: "斜光で風紋が立ち上がる朝夕がすべて。正午は起伏が消える",
    permit: "ガイドと4WDが必須。砂対策 (機材の密閉) が最大の課題" },
  /* ---------- オセアニア・極地 ---------- */
  ...
  { id: "oce-nz", region: "oce", label: "ニュージーランドのフィヨルドと草原",
    en: "a New Zealand fiord and sheep country", tags: ["山水", "牧草", "変わりやすい天気"],
    arch: "isolated farm sheds and fence lines, no towns in frame",
    material: "wet dark rock walls, tussock grass, weathered fence posts",
    signage: "yellow road warning signs with sheep silhouettes",
    vegetation: "beech forest to the waterline, moss, tree ferns in gullies",
    ground: "gravel roads, sheep-cropped green hills, mirror fiord water",
    life: "sheep flocks, a lone campervan, waterfalls after rain",
    sky: "weather changing hourly, shafts of light through broken cloud",
    lightNote: "雲間の光芒が数分単位で動く。待てば必ず一度は劇的な光が来る",
    permit: "DOC(自然保護局)の撮影許可。牧場は所有者の同意が必要" },
  /* ---------- スタジオ・屋内 ---------- */
