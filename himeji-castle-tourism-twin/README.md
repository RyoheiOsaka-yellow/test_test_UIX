...
| 操作 | 動き |
| --- | --- |
| 左ドラッグ | 掴んだ地点を軸に視点を回す（横＝旋回、縦＝ほぼ真上の平面ビュー〜水平近くまで傾ける） |
| 長押し（約0.3秒）→ドラッグ、右／中ドラッグ、Shift／Ctrl＋ドラッグ | 地図を掴んで中心を移動（✋ 表示） |
| ホイール（縦） | カーソル位置に向かってズーム |
| ホイール（横・トラックパッド） | 横スクロール |
| タッチ | 1本指＝回す（長押し＝移動）、2本指＝ピンチズーム＋移動 |
