...
4. ~~経路検索モード~~ → **完了**(駅間グラフ+ダイクストラ。徒歩連絡900m以内・乗換ペナルティ付き。新空港線ON/OFFで所要時間比較、経路を3Dハイライト。所要時間は目安)
5. ~~PLATEAU差し替え~~ → **完了**(CityGML 2023 v4のlod0RoofEdge+measuredHeightで192,968棟・全棟実測高。区外はOSM併用・50mグリッド重複除外)。残: 建物点群のLOD/チャンク化、リプレイ粒子の軌跡テール表示
