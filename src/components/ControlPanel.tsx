...
const TOGGLES: Array<[keyof OverlaySettings, string]> = [
  ...
  ['inspectionGate', 'Inspection gate'],
...
export function ControlPanel() {
  ...
  return (
    <Panel title="Control" bodyClassName="px-2.5 py-2">
      <div className="flex gap-1">
        ...
        <button className="btn" onClick={() => controller.restart()} title="Restart">
          <RotateCcw size={11} />
        </button>
      </div>

      <div className="label mt-3 mb-1">Playback speed</div>
      <div className="flex gap-1">
      ...
      <div className="label mt-3 mb-1">Overlay</div>
        ...
        {TOGGLES.map(([key, label]) => {
          ...
          return (
            <button
              ...
              className="flex items-center justify-between py-[3px] font-mono text-[10.5px] text-ink-2 hover:text-ink disabled:opacity-40"
            >
              <span>{label}</span>
